...
product_mapping_file = f"{data_folder}/product_mapping_data.csv"
main_db_product_file = f"{data_folder}/main_db_product.csv"
mewaahghar_store_1_db_product_file = f"{data_folder}/mewaahghar_store_1_db_product.csv"
accounting_db_product_file = f"{data_folder}/accounting_db_product.csv"
